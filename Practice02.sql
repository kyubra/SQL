...
INSERT INTO child values (105,2000, 'Araba','Burak'); //bu sebeple bu kod calismaz,


--Prant tabloda olmayan PRIMARY KEY ile CHILD tabloya veri girisi yapilamaz.
...
delete from parent where vergi_no=101;// bu sebepten bu kod calismaz.
